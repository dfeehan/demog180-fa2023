...
<BR>
**Web**: <https://www.dennisfeehan.org/teaching/2023fa_demog180.html>   
**Ed page**: <https://edstem.org/us/courses/43235/discussion/>   
**Gradescope page**: <https://www.gradescope.com/courses/585530>   
...
***This syllabus is not yet final, but is intended to give you a sense of what the class will cover. Please re-check the syllabus frequently; it
...
* @easley_networks_2010 Ch.2 (Graphs)

### Working with complete network data {#sec:complete}
...
### Tie strength and homophily {#sec:homophily}
...
* @easley_networks_2010 Ch.4.1-4.2 (Homophily)


### Balance theory {#sec:balance}
